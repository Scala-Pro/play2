...
class HomeController @Inject() (
  ...
  val courseList = List(
    Course("Web dasturlash", 15, 1200000, "yes"),
    Course("Android dasturlash", 5, 1500000, "no"),
    Course("Java", 12, 1700000, "yes"),
    Course("Scala", 10, 1200000, "no"),
    Course("Video mantaj", 11, 2200000, "yes"))
  ...
  def getCourses: Action[AnyContent] = Action { implicit request =>
    {
